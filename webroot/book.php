	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<p>Our next Dojo is on the 19th November 2017 from 11am to 3pm. Places are limited so please use the form below to book yours. Tickets <?php echo (time() > strtotime('2017-11-01 00:00:01') ) ? 'are available now' : 'will be available from 1st November 2017'; ?>.</p>
                <p><em>Don't forget, Ninjas under 13 will need an adult to stay with them.</em></p>

                <div style="width:100%; text-align:left;">
                    <iframe
                        src="//eventbrite.co.uk/tickets-external?eid=38918209412&ref=etckt"
                        frameborder="0" height="600"
                        width="100%" vspace="0" hspace="0" marginheight="5" marginwidth="5"
                        scrolling="auto" allowtransparency="true" style="background-color: #108a93;"></iframe>
